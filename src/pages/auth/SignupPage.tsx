        ...
        <div className="glass-enhanced p-8 rounded-2xl border border-amber-500/30">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              disabled={loading}
              className="w-full glass-card hover:glass-enhanced border border-white/20 hover:border-amber-400/50 p-3 rounded-lg transition-all duration-300 flex items-center justify-center space-x-3 group"
            >
